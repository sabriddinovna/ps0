...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
      ...
      if (writtenByYourself) {
          System.out.print(" self written ");
      }
      else {
          if (availableToOthers) {
              System.out.print(" publicly available ");
      }
      if (writtenAsCourseWork) {
          System.out.print(" written-as-course-work ");
      }
      if (citingYourSource) {
          System.out.print(" properly cited ");
      }
          if (!citingYourSource) {
              System.out.print(" uncited ");
          }

      }
      if (implementationRequired) {
          System.out.print(" feature-required ");
      }
